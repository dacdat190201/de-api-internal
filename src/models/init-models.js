...
function initModels(sequelize) {
  ...
  order_details.hasMany(order_item, {
    as: "order_items",
    foreignKey: "order_id",
  });
  ...
  order_details.hasMany(payment_details, {
    as: "payment_details",
    foreignKey: "order_id",
  });
  ...
  product_attributes.belongsTo(products, {
    as: "product",
  ...
  products.belongsTo(sub_categories, {
    as: "category",
    foreignKey: "category_id",
  });
  sub_categories.hasMany(products, {
    as: "products",
    foreignKey: "category_id",
  });
